          ...
          <div>
            ...
            <div>
              <Accordion type="single" collapsible className="w-full mt-14">
                <AccordionItem value="item-1" className="border p-2 mt-2">
                  <AccordionTrigger>
                ...
                <AccordionItem value="item-2" className="border p-2 mt-2">
                  <AccordionTrigger>
                ...
                <AccordionItem value="item-3" className="border p-2 mt-2">
